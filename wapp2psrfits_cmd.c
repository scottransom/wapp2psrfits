...
static Cmdline cmd = {
  /***** -n: The number of simultaneous WAPPs to combine */
  /* numwappsP = */ 1,
  /* numwapps = */ 1,
  /* numwappsC = */ 1,
...
usage(void)
{
  fprintf(stderr,"%s","   [-n numwapps] [-b numbits] [-g outlenGB] -o outfile [-i] [--] infiles ...\n");
  fprintf(stderr,"%s","      Converts search-mode WAPP data into PSRFITS\n");
  fprintf(stderr,"%s","         -n: The number of simultaneous WAPPs to combine\n");
  fprintf(stderr,"%s","             1 int value between 1 and 4\n");
  ...
  fprintf(stderr,"%s","    infiles: Input WAPP file names (in time/WAPP order)\n");
  fprintf(stderr,"%s","             1...100 values\n");
  fprintf(stderr,"%s","  version: 25Jan10\n");
  fprintf(stderr,"%s","  ");
  exit(EXIT_FAILURE);
}
/**********************************************************************/
...
parseCmdline(int argc, char **argv)
{
  ...
  for(i=1, cmd.argc=1; i<argc; i++) {
    ...
    if( 0==strcmp("-n", argv[i]) ) {
      ...
      checkIntLower("-n", &cmd.numwapps, cmd.numwappsC, 4);
      checkIntHigher("-n", &cmd.numwapps, cmd.numwappsC, 1);
      continue;
    }
